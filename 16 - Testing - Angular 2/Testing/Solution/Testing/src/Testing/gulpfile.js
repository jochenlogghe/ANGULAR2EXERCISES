...
paths.jasminejs = "node_modules/jasmine-core/lib/jasmine-core/*.js";
paths.jasminecss = "node_modules/jasmine-core/lib/jasmine-core/*.css";
paths.jasmineDest = paths.webroot + "lib/jasmine";
...
gulp.task("default", ["angular2", "rxjs", "systemjs", "es6shim", "jasmine"]);
...
gulp.task("jasmine", function () {
    return gulp.src([paths.jasminejs, paths.jasminecss])
      .pipe(gulp.dest(paths.jasmineDest));
});
