...
paths.jqueryjs = "node_modules/jquery/dist/jquery.min.js";
paths.jqueryDest = paths.webroot + "lib/jquery";
paths.materialize = "node_modules/materialize-css/dist/**/*.*";
paths.materializeDest = paths.webroot + "lib/materialize-css";
...
gulp.task("default", ["angular2", "rxjs", "systemjs", "es6shim", "jquery","materialize"]);
